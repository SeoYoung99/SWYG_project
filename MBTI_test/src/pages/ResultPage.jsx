      ...
      return (
        <div>
          ...
          <div className="ScoreText">
            ...
            <span
              className="MBTIColor"
              style={{ backgroundColor: MBTIStyle(props.mbti) }}
            >
              {props.mbti}
            </span>
            에 대해 정말 하나도 모르시는군요 😂{' '}
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await axios.post(
        'https://swyg-mbti-quiz.herokuapp.com/result',
        {
          userMbti: yourMbti,
          quizMbti: MBTI,
          score: score,
  ...
  return (
    <div className="Result">
        ...
        <div style={{ textAlign: 'center', paddingTop: '2px' }}>
          <span
            style={{
              width: '60px',
              height: '36px',
              backgroundColor: MBTIStyle(props.mbti),
            }}
            className="MBTIColor"
          >
            {props.mbti}
          ...
          >
            <div className="Rank2">
              <div
                style={{
                  color: MBTIStyle(
                    data.length > 0 ? data[1].mbti : '불러오는 중..'
                  ),
                }}
              >
                {data.length > 0 ? data[1].mbti : '불러오는 중..'}
            ...
            <div className="Rank1">
              <div
                style={{
                  color: MBTIStyle(
                    data.length > 0 ? data[0].mbti : '불러오는 중..'
                  ),
                }}
              >
                {data.length > 0 ? data[0].mbti : '불러오는 중..'}
            ...
            <div className="Rank3">
              <div
                style={{
                  color: MBTIStyle(
                    data.length > 0 ? data[2].mbti : '불러오는 중..'
                  ),
                }}
              >
                {data.length > 0 ? data[2].mbti : '불러오는 중..'}
      ...
      <div style={{ display: 'flex', paddingBottom: 10 }}>
        <div className="AgainBtn" onClick={testAgain}>
          다시 테스트하기
        </div>
        <div className="Share" onClick={handle}>
          공유하기
        </div>
      </div>
    </div>
