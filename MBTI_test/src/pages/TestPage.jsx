  ...
  return (
    <p className="Percent">
      ...
      <div className="Logo" style={{ marginLeft: px }}>
        <div
          style={{ paddingTop: '22px', paddingLeft: '4px', fontSize: '13px' }}
        >
          {percent}0%
        </div>
      </div>
...
function TestPage(props) {
  ...
  const answerList = [
    {
      a1: '"응 그랭 잘가!" 쿨하게 보내줄 것 같다',
      a2: "'헉 오늘 무슨일 있나..?' 신경쓸 것 같다",
    },
    {
      a1: '당분간 돌아다니지 말아야겠다고 생각할 것 같다',
      a2: "'무슨일일까??' 궁금해할 것 같다",
    },
    {
      a1: '"나 다쳤다구ㅜㅜ" 서운해한다',
    ...
    {
      a1: '사람들과 만나 놀아야 한다. 집에 혼자 있으면 괜히 울적해지기만 한다.',
      a2: '집에서 조용히 쉬고 싶다. 이럴 때 나가봤자 기만 빨린다.',
    },
    {
      a1: '"날 위해서 3시간이나 만들었다고? 진짜 감동이야ㅠ"',
      a2: '"나쁘지 않은데? 근데 조금 단 것 같아서 다음엔 덜 달게 하면 완벽할 것 같아! 고마워!"',
    },
    { a1: '바로 갖다버린다.', a2: '일단 그냥 둔다. ' },
    {
      a1: '내가 기대하고 계획한 대로 흘러가서 잘 놀고오면 좋겠다~',
      a2: '계획을 굳이 세워야 해? 재밌게 놀다오면 그게 힐링이지~',
    },
    {
      a1: "'아 공부하기 싫다. 시험범위가 절반으로 줄어들면 좋을텐데'",
      a2: "'아 공부하기 싫다. 투명인간이 된다면 좋을텐데'",
    },
    {
      a1: '내가 말하기 전까지는 속으로 뭘 잘못했나 생각한다.',
      a2: '뭐가 문제인지, 왜 화가 났는지 나에게 바로 물어본다.',
    },
    {
      a1: '서프라이즈!  감동적인 편지와 함께 아기자기한/멋진 선물',
      a2: '나에게 직접 물어봐주고 고른 실용적이고 필요한 선물',
    },
  ]
    ...
    <div className="Background">
      <div className="Center">
        ...
        <div className="Question">
          <div className="MBTI" style={{ backgroundColor: MBTIStyle(MBTI) }}>
            {MBTI}
          </div>
          {quizList[quiz - 1]}
        </div>
        <div style={{ paddingTop: '12px' }}>
          <div
            className={style === '1' ? 'Answered' : 'Answer'}
            onClick={() => setStyle('1')}
          >
            {answerList[quiz - 1].a1}
          </div>
          <div
            className={style === '2' ? 'Answered' : 'Answer'}
            onClick={() => setStyle('2')}
          >
            {answerList[quiz - 1].a2}
          </div>
        </div>
        <div style={{ display: 'flex' }}>
          <div className="NextBtn" onClick={previousQuiz}>
            ← 이전
          </div>
